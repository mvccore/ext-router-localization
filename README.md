...
4. [Usage](#user-content-4-usage)  
	...
	4.4. [Usage - Allow Non-Localized Routes](#user-content-44-usage---allow non-localized-routes)  
	4.5. [Usage - Detect Localization Only By Language](#user-content-45-usage---detect-localization-only-by-language)  
	4.6. [Usage - Localization Equivalents](#user-content-46-usage---localization-equivalents)  
	4.7. [Usage - Route Records By Language And Locale](#user-content-47-usage---route-records-by-language-and-locale)  
	4.8. [Usage - Redirect To Default And Back In First Request](#user-content-48-usage---redirect-to-default-and-back-in-first-request)  
	4.9. [Usage - Localized URL In Non-Localized Request](#user-content-49-usage---localized-url-in-non-localized-request)  
